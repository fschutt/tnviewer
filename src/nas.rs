...
const MAP: &[(&str, &str);163] = &[
    ("WBFPA", "ebene=AX_Wohnbauflaeche,funktion=1200"),
    ("WBF", "ebene=AX_Wohnbauflaeche"),
    ("A", "ebene=AX_Landwirtschaft,vegetationsmerkmal=1010"),
    ("SOA", "ebene=AX_Landwirtschaft,vegetationsmerkmal=1011"),
    ("HOP", "ebene=AX_Landwirtschaft,vegetationsmerkmal=1013"),
    ("GR", "ebene=AX_Landwirtschaft,vegetationsmerkmal=1020"),
    ("SOW", "ebene=AX_Landwirtschaft,vegetationsmerkmal=1021"),
    ("SAW", "ebene=AX_Landwirtschaft,vegetationsmerkmal=1022"),
    ("G", "ebene=AX_Landwirtschaft,vegetationsmerkmal=1030"),
    ("BAUM", "ebene=AX_Landwirtschaft,vegetationsmerkmal=1031"),
    ("REB", "ebene=AX_Landwirtschaft,vegetationsmerkmal=1040"),
    ("OBP", "ebene=AX_Landwirtschaft,vegetationsmerkmal=1050"),
    ("OBBP", "ebene=AX_Landwirtschaft,vegetationsmerkmal=1051"),
    ("WEIH", "ebene=AX_Landwirtschaft,vegetationsmerkmal=1060"),
    ("KURZ", "ebene=AX_Landwirtschaft,vegetationsmerkmal=1100"),
    ("BRA", "ebene=AX_Landwirtschaft,vegetationsmerkmal=1200"),
    ("LW", "ebene=AX_Landwirtschaft"),
    ("WABFVNL", "ebene=AX_Wald,vegetationsmerkmal=1100,nutzung=3000,zustand=6100"),
    ("VNFL", "ebene=AX_Wald,vegetationsmerkmal=1100,nutzung=1000,zustand=6100"),
    ("WABFVNN", "ebene=AX_Wald,vegetationsmerkmal=1200,nutzung=3000,zustand=6100"),
    ("VNFN", "ebene=AX_Wald,vegetationsmerkmal=1200,nutzung=1000,zustand=6100"),
    ("WABFVLN", "ebene=AX_Wald,vegetationsmerkmal=1300,nutzung=3000,zustand=6100"),
    ("VNFLN", "ebene=AX_Wald,vegetationsmerkmal=1300,nutzung=1000,zustand=6100"),
    ("LH", "ebene=AX_Wald,vegetationsmerkmal=1100"),
    ("NH", "ebene=AX_Wald,vegetationsmerkmal=1200"),
    ("LNH", "ebene=AX_Wald,vegetationsmerkmal=1300"),
    ("WABFVLN", "ebene=AX_Wald,nutzung=3000,zustand=6100"),
    ("VNPF", "ebene=AX_Wald,nutzung=1000,zustand=6100"),
    ("FWF", "ebene=AX_Wald,nutzung=1000"),
    ("WABF", "ebene=AX_Wald,nutzung=3000"),
    ("WALD", "ebene=AX_Wald"),
    ("VSWA", "ebene=AX_IndustrieUndGewerbeflaeche,funktion=2500,primaerenergie=1000 "),
    ("VSKK", "ebene=AX_IndustrieUndGewerbeflaeche,funktion=2500,primaerenergie=2000 "),
    ("VSSO", "ebene=AX_IndustrieUndGewerbeflaeche,funktion=2500,primaerenergie=3000 "),
    ("VSWI", "ebene=AX_IndustrieUndGewerbeflaeche,funktion=2500,primaerenergie=4000 "),
    ("VSVE", "ebene=AX_IndustrieUndGewerbeflaeche,funktion=2500,primaerenergie=7000 "),
    ("VSKO", "ebene=AX_IndustrieUndGewerbeflaeche,funktion=2500,primaerenergie=7100 "),
    ("FÖG", "ebene=AX_IndustrieUndGewerbeflaeche,funktion=2700,foerdergut=2000"),
    ("VSKWA", "ebene=AX_IndustrieUndGewerbeflaeche,funktion=2530, primaerenergie=1000"),
    ("VSKKK", "ebene=AX_IndustrieUndGewerbeflaeche,funktion=2530, primaerenergie=2000"),
    ("VSKSO", "ebene=AX_IndustrieUndGewerbeflaeche,funktion=2530, primaerenergie=3000"),
    ("VSKWI", "ebene=AX_IndustrieUndGewerbeflaeche,funktion=2530, primaerenergie=4000"),
    ("VSKVE", "ebene=AX_IndustrieUndGewerbeflaeche,funktion=2530, primaerenergie=7000"),
    ("VSKKO", "ebene=AX_IndustrieUndGewerbeflaeche,funktion=2530, primaerenergie=7100"),
    ("VSHWA", "ebene=AX_IndustrieUndGewerbeflaeche,funktion=2570, primaerenergie=1000"),
    ("VSHKK", "ebene=AX_IndustrieUndGewerbeflaeche,funktion=2570, primaerenergie=2000"),
    ("VSHSO", "ebene=AX_IndustrieUndGewerbeflaeche,funktion=2570, primaerenergie=3000"),
    ("VSHWI", "ebene=AX_IndustrieUndGewerbeflaeche,funktion=2570, primaerenergie=4000"),
    ("VSHVE", "ebene=AX_IndustrieUndGewerbeflaeche,funktion=2570, primaerenergie=7000"),
    ("VSHKO", "ebene=AX_IndustrieUndGewerbeflaeche,funktion=2570, primaerenergie=7100"),
    ("FÖ", "ebene=AX_IndustrieUndGewerbeflaeche,funktion=2700"),
    ("VSW", "ebene=AX_IndustrieUndGewerbeflaeche,funktion=2520"),
    ("VSK", "ebene=AX_IndustrieUndGewerbeflaeche,funktion=2530"),
    ("VSU", "ebene=AX_IndustrieUndGewerbeflaeche,funktion=2540"),
    ("VSH", "ebene=AX_IndustrieUndGewerbeflaeche,funktion=2570"),
    ("IGFPA", "ebene=AX_IndustrieUndGewerbeflaeche,funktion=1200"),
    ("HD", "ebene=AX_IndustrieUndGewerbeflaeche,funktion=1400"),
    ("HDH", "ebene=AX_IndustrieUndGewerbeflaeche,funktion=1440"),
    ("HDM", "ebene=AX_IndustrieUndGewerbeflaeche,funktion=1450"),
    ("HDG", "ebene=AX_IndustrieUndGewerbeflaeche,funktion=1490"),
    ("VS", "ebene=AX_IndustrieUndGewerbeflaeche,funktion=2500"),
    ("ES", "ebene=AX_IndustrieUndGewerbeflaeche,funktion=2600"),
    ("ESA", "ebene=AX_IndustrieUndGewerbeflaeche,funktion=2610"),
    ("ESDO", "ebene=AX_IndustrieUndGewerbeflaeche,funktion=2630"),
    ("ESDU", "ebene=AX_IndustrieUndGewerbeflaeche,funktion=2640"),
    ("IG", "ebene=AX_IndustrieUndGewerbeflaeche"),
    ("TGTAB", "ebene=AX_TagebauGrubeSteinbruch,abbaugut=1001,zustand=2100"),
    ("TGT", "ebene=AX_TagebauGrubeSteinbruch,abbaugut=1001"),
    ("TGLAB", "ebene=AX_TagebauGrubeSteinbruch,abbaugut=1004,zustand=2100"),
    ("TGL", "ebene=AX_TagebauGrubeSteinbruch,abbaugut=1004"),
    ("TGSAB", "ebene=AX_TagebauGrubeSteinbruch,abbaugut=1008,zustand=2100"),
    ("TGS", "ebene=AX_TagebauGrubeSteinbruch,abbaugut=1008"),
    ("TGKIAB", "ebene=AX_TagebauGrubeSteinbruch,abbaugut=1009,zustand=2100"),
    ("TGKI", "ebene=AX_TagebauGrubeSteinbruch,abbaugut=1009"),
    ("TGQAB", "ebene=AX_TagebauGrubeSteinbruch,abbaugut=1012,zustand=2100"),
    ("TGQ", "ebene=AX_TagebauGrubeSteinbruch,abbaugut=1012"),
    ("TGKSAB", "ebene=AX_TagebauGrubeSteinbruch,abbaugut=2005,zustand=2100"),
    ("TGKS", "ebene=AX_TagebauGrubeSteinbruch,abbaugut=2005"),
    ("TGGAB", "ebene=AX_TagebauGrubeSteinbruch,abbaugut=2010,zustand=2100"),
    ("TGG", "ebene=AX_TagebauGrubeSteinbruch,abbaugut=2010"),
    ("TGTFAB", "ebene=AX_TagebauGrubeSteinbruch,abbaugut=4010,zustand=2100"),
    ("TGTF", "ebene=AX_TagebauGrubeSteinbruch,abbaugut=4010"),
    ("TGBAB", "ebene=AX_TagebauGrubeSteinbruch,abbaugut=4021,zustand=2100"),
    ("TGB", "ebene=AX_TagebauGrubeSteinbruch,abbaugut=4021"),
    ("TGPA", "ebene=AX_TagebauGrubeSteinbruch,funktion=1200"),
    ("TG", "ebene=AX_TagebauGrubeSteinbruch"),
    ("BEAB", "ebene=AX_Bergbaubetrieb,zustand=2100"),
    ("BE", "ebene=AX_Bergbaubetrieb"),
    ("SFS", "ebene=AX_SportFreizeitUndErholungsflaeche,funktion=4100"),
    ("SFG", "ebene=AX_SportFreizeitUndErholungsflaeche,funktion=4110"),
    ("SFZ", "ebene=AX_SportFreizeitUndErholungsflaeche,funktion=4200"),
    ("SFWP", "ebene=AX_SportFreizeitUndErholungsflaeche,funktion=4220"),
    ("SFB", "ebene=AX_SportFreizeitUndErholungsflaeche,funktion=4240"),
    ("SFM", "ebene=AX_SportFreizeitUndErholungsflaeche,funktion=4250"),
    ("SFA", "ebene=AX_SportFreizeitUndErholungsflaeche,funktion=4260"),
    ("SFMO", "ebene=AX_SportFreizeitUndErholungsflaeche,funktion=4290"),
    ("EH", "ebene=AX_SportFreizeitUndErholungsflaeche,funktion=4300"),
    ("WFH", "ebene=AX_SportFreizeitUndErholungsflaeche,funktion=4310"),
    ("SCHW", "ebene=AX_SportFreizeitUndErholungsflaeche,funktion=4320"),
    ("CAM", "ebene=AX_SportFreizeitUndErholungsflaeche,funktion=4330"),
    ("GRÜ", "ebene=AX_SportFreizeitUndErholungsflaeche,funktion=4400"),
    ("PARK", "ebene=AX_SportFreizeitUndErholungsflaeche,funktion=4420"),
    ("SFPA", "ebene=AX_SportFreizeitUndErholungsflaeche,funktion=4440"),
    ("SF", "ebene=AX_SportFreizeitUndErholungsflaeche"),
    ("MIPA", "ebene=AX_FlaecheGemischterNutzung,funktion=1200"),
    ("MILB", "ebene=AX_FlaecheGemischterNutzung,funktion=6800"),
    ("MIFB", "ebene=AX_FlaecheGemischterNutzung,funktion=7600"),
    ("MIFW", "ebene=AX_FlaecheGemischterNutzung,funktion=3000"),
    ("BPÖ", "ebene=AX_FlaecheBesondererFunktionalerPraegung,funktion=1100"),
    ("BPV", "ebene=AX_FlaecheBesondererFunktionalerPraegung,funktion=1110"),
    ("BPB", "ebene=AX_FlaecheBesondererFunktionalerPraegung,funktion=1120"),
    ("BPK", "ebene=AX_FlaecheBesondererFunktionalerPraegung,funktion=1130"),
    ("BPR", "ebene=AX_FlaecheBesondererFunktionalerPraegung,funktion=1140"),
    ("BPG2", "ebene=AX_FlaecheBesondererFunktionalerPraegung,funktion=1150"),
    ("BPS", "ebene=AX_FlaecheBesondererFunktionalerPraegung,funktion=1160"),
    ("BPO2", "ebene=AX_FlaecheBesondererFunktionalerPraegung,funktion=1170"),
    ("BPPA", "ebene=AX_FlaecheBesondererFunktionalerPraegung,funktion=1200"),
    ("BPHA", "ebene=AX_FlaecheBesondererFunktionalerPraegung,funktion=1300"),
    ("BP", "ebene=AX_FlaecheBesondererFunktionalerPraegung"),
    ("FPA", "ebene=AX_Friedhof,funktion=1200"),
    ("F", "ebene=AX_Friedhof"),
    ("SB", "ebene=AX_Strassenverkehr,funktion=2312"),
    ("FUß", "ebene=AX_Strassenverkehr,funktion=5130"),
    ("S", "ebene=AX_Strassenverkehr"),
    ("WEG", "ebene=AX_Weg"),
    ("P", "ebene=AX_Platz,funktion=5310"),
    ("RAP", "ebene=AX_Platz,funktion=5320"),
    ("RAS", "ebene=AX_Platz,funktion=5330"),
    ("FP", "ebene=AX_Platz,funktion=5350"),
    ("PL", "ebene=AX_Platz"),
    ("BAPA", "ebene=AX_Bahnverkehr,funktion=1200"),
    ("BAB", "ebene=AX_Bahnverkehr,funktion=2322"),
    ("BA", "ebene=AX_Bahnverkehr"),
    ("IFH", "ebene=AX_Flugverkehr,art=5511"),
    ("RFH", "ebene=AX_Flugverkehr,art=5512"),
    ("SFH", "ebene=AX_Flugverkehr,art=5513"),
    ("VLP", "ebene=AX_Flugverkehr,art=5521"),
    ("SLP", "ebene=AX_Flugverkehr,art=5522"),
    ("HLP", "ebene=AX_Flugverkehr,art=5530"),
    ("SFLG", "ebene=AX_Flugverkehr,art=5550"),
    ("FLPA", "ebene=AX_Flugverkehr,funktion=1200"),
    ("FL", "ebene=AX_Flugverkehr"),
    ("SVPA", "ebene=AX_Schiffsverkehr,funktion=1200"),
    ("SVH", "ebene=AX_Schiffsverkehr,funktion=5610"),
    ("SVS", "ebene=AX_Schiffsverkehr,funktion=5620"),
    ("SV", "ebene=AX_Schiffsverkehr"),
    ("GHÖ", "ebene=AX_Gehoelz"),
    ("HEI", "ebene=AX_Heide"),
    ("MOOR", "ebene=AX_Moor"),
    ("SUM", "ebene=AX_Sumpf"),
    ("HAL", "ebene=AX_Halde"),
    ("UVS", "ebene=AX_UnlandVegetationsloseFlaeche,funktion=1000,oberflaechenmaterial=1020"),
    ("UVS", "ebene=AX_UnlandVegetationsloseFlaeche,funktion=1000,oberflaechenmaterial=1030"),
    ("UVSA", "ebene=AX_UnlandVegetationsloseFlaeche,funktion=1000,oberflaechenmaterial=1040"),
    ("WAB", "ebene=AX_UnlandVegetationsloseFlaeche,funktion=1100"),
    ("NF", "ebene=AX_UnlandVegetationsloseFlaeche,funktion=1300"),
    ("UV", "ebene=AX_UnlandVegetationsloseFlaeche"),
    ("KAN", "ebene=AX_Fliessgewaesser,funktion=8300"),
    ("WAF", "ebene=AX_Fliessgewaesser"),
    ("WAH", "ebene=AX_Hafenbecken"),
    ("STS", "ebene=AX_StehendesGewaesser,funktion=8630"),
    ("SPB", "ebene=AX_StehendesGewaesser,funktion=8631"),
    ("WAS", "ebene=AX_StehendesGewaesser"),
];

impl TaggedPolygon {

    pub fn get_auto_attributes_for_kuerzel(kuerzel: &str) -> BTreeMap<String, String> {
        ...
        Self {
            ...
            flurstuecke_nutzungen: self.flurstuecke_nutzungen.iter().map(|(k, v)| {
                ...
                .filter_map(|ai| if ai.flst_id == *k {
                    Some(TaggedPolygon {
                        attributes: TaggedPolygon::get_auto_attributes_for_kuerzel(&ai.neu),
