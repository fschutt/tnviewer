...
pub fn get_problem_geojson() -> String {
    ...
    let poly_string1 = r#"{"outer_rings":[{"points":[{"x":423523.642,"y":5918645.266},{"x":423551.7886123582,"y":5918634.482314402},{"x":423554.687,"y":5918633.372},{"x":423584.515,"y":5918621.944},{"x":423603.732,"y":5918617.098},{"x":423614.007,"y":5918615.935},{"x":423621.285,"y":5918616.763},{"x":423625.002,"y":5918619.067},{"x":423629.779,"y":5918622.028},{"x":423637.891,"y":5918631.953},{"x":423649.411,"y":5918649.03},{"x":423658.096,"y":5918661.904},{"x":423664.548,"y":5918668.121},{"x":423670.173,"y":5918676.24},{"x":423678.308,"y":5918687.981},{"x":423692.453,"y":5918694.429},{"x":423719.491,"y":5918695.504},{"x":423756.608,"y":5918692.526},{"x":423774.632,"y":5918691.081},{"x":423898.278,"y":5918681.162},{"x":423932.33,"y":5918677.5},{"x":423983.801,"y":5918675.04},{"x":424032.84,"y":5918672.695},{"x":424084.825,"y":5918670.209},{"x":424255.164,"y":5918662.057},{"x":424292.608,"y":5918661.932},{"x":424300.577,"y":5918661.934},{"x":424330.184,"y":5918661.993},{"x":424341.43,"y":5918661.948},{"x":424342.335,"y":5918677.096},{"x":424326.146,"y":5918676.323},{"x":424205.797,"y":5918683.577},{"x":423952.814,"y":5918692.328},{"x":423927.823,"y":5918693.192},{"x":423723.378,"y":5918712.73},{"x":423690.056,"y":5918716.433},{"x":423683.394,"y":5918716.415},{"x":423681.597,"y":5918712.763},{"x":423655.728,"y":5918674.734},{"x":423650.468,"y":5918665.611},{"x":423635.086,"y":5918648.928},{"x":423630.339,"y":5918640.493},{"x":423622.041,"y":5918633.206},{"x":423608.182,"y":5918628.342},{"x":423598.369,"y":5918628.789},{"x":423578.096,"y":5918634.058},{"x":423530.253,"y":5918651.186},{"x":423527.433,"y":5918652.197},{"x":423516.763,"y":5918657.885},{"x":423513.719,"y":5918659.484},{"x":423510.228,"y":5918650.82},{"x":423523.642,"y":5918645.266}]}],"inner_rings":[]}"#;
    let poly_string2 = "";
...
pub fn lib_nutzungen_saeubern(
    ...
    .clean_stage3(&nas_original, &mut log, konfiguration.merge.stage3_maxdst_line, konfiguration.merge.stage3_maxdst_line2);
...
pub fn lib_get_aenderungen_clean(id: String, aenderungen: String, split_nas_xml: String, nas_original: String, konfiguration: String) -> String {
    ...
    let clean = match id.as_str() {
        ...
        "3" => aenderungen.clean_stage3(&nas_original, &mut log, konfiguration.merge.stage3_maxdst_line, konfiguration.merge.stage3_maxdst_line2),
        "13" => {
            aenderungen
            .clean_stage1(&split_nas_xml, &mut log, konfiguration.merge.stage1_maxdst_point, konfiguration.merge.stage1_maxdst_line)
            .clean_stage2(&split_nas_xml, &mut log, konfiguration.merge.stage2_maxdst_point, konfiguration.merge.stage2_maxdst_line)
